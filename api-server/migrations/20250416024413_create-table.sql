...
CREATE TABLE product_buy_history (
    id INTEGER NOT NULL PRIMARY KEY,
    product_variation_id INTEGER NOT NULL FOREIGN KEY REFERENCES product_variation_id(id),
    buy_history_id INTEGER NOT NULL FOREIGN KEY REFERENCES buy_history(id),
...
CREATE TABLE product_sell_history (
    id INTEGER NOT NULL PRIMARY KEY,
    product_variation_id INTEGER NOT NULL FOREIGN KEY REFERENCES product_variation_id(id),
    sell_history_id INTEGER NOT NULL FOREIGN KEY REFERENCES sell_history(id),
    unit_value DECIMAL(10,2) NOT NULL,
    quantity DECIMAL(10,2) NOT NULL,
);
